...
const handlers = {
   ...
   index(data, callback) {
      handlers._htmlHandler(
         "Uptime Monitoring - Made Simple",
         "Free simple uptime monitoring for HTTP/HTTPS sites. When your site goes down, we'll send you a text.",
         "index",
         "index",
         data,
         callback
   ...
   accountCreate(data, callback) {
      handlers._htmlHandler(
         "Create an Account",
         "Signup is easy and only takes a few seconds.",
         "accountCreate",
         "accountCreate",
         data,
         callback
   ...
   _htmlHandler(title, desc, bodyClass, template, data, callback) {
      ...
      if (data.method === "get") {
         ...
         helpers.getTemplate(template, templateData, function(err, str) {
            if (!err && str) {
   ...
   _users: {
      ...
      post(data, callback) {
         ...
         const firstName = validation.getValidatedString(
            data.payload.firstName
         );
         const lastName = validation.getValidatedString(data.payload.lastName);
